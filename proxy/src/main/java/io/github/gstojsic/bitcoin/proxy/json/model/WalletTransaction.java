...
public class WalletTransaction {
     ...
     * details
     */
    private List<WalletTransactionDetails> details;

    /**
     * (string) Raw data for transaction
     */
    private String hex;

    /**
     * (json object, optional) The decoded transaction (only present when `verbose` is passed)
     * Equivalent to the RPC decoderawtransaction method, or the RPC getrawtransaction method when `verbose` is passed.
     */
    private RawTransaction decoded;
    ...
    public List<WalletTransactionDetails> getDetails() {
        return details;
    }

    public void setDetails(List<WalletTransactionDetails> details) {
    ...
    public RawTransaction getDecoded() {
        return decoded;
    }

    public void setDecoded(RawTransaction decoded) {
